...
CREATE TABLE [User] (
    ...
    CONSTRAINT FK_User_StreamingService FOREIGN KEY (streaming_services_id) REFERENCES StreamingService(id) ON DELETE SET NULL,
    CONSTRAINT FK_User_Title FOREIGN KEY (recently_viewed_show_id) REFERENCES Title(id) ON DELETE SET NULL
);